...
# два словаря в помощь
eng = 'qwertyuiopasdfghjklzxcvbnm'
rus = 'йцукенгшщзхъфывапролджэячсмитьбюё'

cost_eng = {1:'AEIOULNSTR',
      	2:'DG',
      	3:'BCMP',
      	4:'FHVWY',
      	5:'K',
...
if word[0].lower() in eng:
    summa = 0
    for letter in word:
        for key, value in cost_eng.items():
            if letter.upper() in value:
                summa += key
    print(f'Cтоимость введенного английского слова = {summa}')
else:
    if word[0].lower() in rus:
        summa = 0
        for letter in word:
            for key, value in cost_rus.items():
                if letter.upper() in value:
                    summa += key
    print(f'Cтоимость введенного русского слова = {summa}')
